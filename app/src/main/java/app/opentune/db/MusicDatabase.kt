...
import app.opentune.db.MusicDatabase.Companion.MUSIC_DATABASE_VERSION
import app.opentune.db.entities.AlbumArtistMap
...
import app.opentune.db.entities.PlayCountEntity
import app.opentune.db.entities.PlaylistEntity
import app.opentune.db.entities.PlaylistEntity.Companion.generatePlaylistId
import app.opentune.db.entities.PlaylistSongMap
import app.opentune.db.entities.PlaylistSongMapPreview
...
@Database(
    ...
    autoMigrations = [
        ...
        AutoMigration(from = 23, to = 24), // index liked, likedDate, inLibrary for faster favourites
    ]
)
