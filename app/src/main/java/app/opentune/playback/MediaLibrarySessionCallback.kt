...
import app.opentune.constants.MediaSessionConstants
...
import app.opentune.extensions.toggleShuffleMode
...
//                    .setArtworkUri(song.thumbnailUrl?.toUri())
    ...
    private fun app.opentune.models.MediaMetadata.toMediaItem(isPlayable: Boolean = true, isBrowsable: Boolean = false) = MediaItem.Builder()
        .setMediaId(id)
        .setUri(id)
