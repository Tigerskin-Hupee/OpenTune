...
| Version | Highlights |
|---|---|
| **2.0.11** | Faster downloads: explicit range parameter bypasses YouTube CDN throttling (~playback-speed cap), cutting per-song download time from minutes to seconds |
